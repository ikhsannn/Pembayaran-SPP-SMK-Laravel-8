    ...
    <div style="width: 100%; padding: 5px; border-top: 2px solid black; box-sizing: border-box">
        ...
        <div style="display: block; width: 100%; overflow-x: hidden;">
            <table border="1" cellpadding="10" cellspacing="0" align="center" style="font-size: 0.8em">
                ...
                <tr>
                    <td>{{ $educational_guidance_donation_transaction->user->student_information->student_identification_number }}</td>
                    <td>{{ $educational_guidance_donation_transaction->user->name }}</td>
                    <td>{{ $educational_guidance_donation_transaction->user->student_information->student_class->name ?? null }} - {{ $educational_guidance_donation_transaction->user->student_information->school_year ?? null }}</td>
                    ...
                    <td>{{ $educational_guidance_donation_transaction->bill ?? null }}</td>
